...
lazy val sbtPlug: Project = project.in(file("sbt-plugin"))
  ...
  .settings(
    ...
    sourceGenerators in Compile += Def.task {
      ...
      val wartsDir = core.base / "src" / "main" / "scala" / "io" / "omervk" / "wartremover" / "spark" / "warts"
      ...
      val content =
        s"""package wartremover.spark
           ...
           |  private[this] def w(nm: String): Wart = new Wart(s"io.omervk.wartremover.spark.warts.$$nm")
           |""".stripMargin +
